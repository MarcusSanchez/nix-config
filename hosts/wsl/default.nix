...
# whatever PC hosts the distro. Per-machine differences live as
# hostname lists beside what they gate (wsl/networking.nix's
# bridgedPCs, common/secrets.nix's trusted).
#
