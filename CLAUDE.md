...
nix eval --raw '/etc/nixos#darwinConfigurations."marcuss-mac-mini".system.drvPath'
                                               # eval the mac systems after touching darwin/ or home/
