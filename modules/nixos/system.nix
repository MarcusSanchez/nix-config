...
# audio, and the devices you plug in or pair — their firmware and
# their power state. Several small concerns grouped by purpose; each
# would otherwise be a near-one-line file.
{ pkgs, ... }:
